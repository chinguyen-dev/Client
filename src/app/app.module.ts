...
import { SiderbarComponent } from './components/admins/siderbar/siderbar.component';
...
import { ProductComponent } from './components/admins/product/product.component';
import { SliderComponent } from './components/admins/slider/slider.component';
import { AdminComponent } from './component/admin/admin.component';
import { SidebarComponent } from './components/admin/sidebar/sidebar.component';

@NgModule({
  declarations: [AppComponent, HeaderComponent, FooterComponent, SiderbarComponent, CartComponent, LoginComponent, RegisterComponent, ProductComponent, SliderComponent, AdminComponent, SidebarComponent],
  imports: [
    BrowserModule,
